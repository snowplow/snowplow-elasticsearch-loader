 ...
 */
package com.snowplowanalytics.snowplow.elasticsearch.it.opensearch
...
class OpenSearchV1Spec extends EnrichedSpec {

  override val resource: Resource[IO, TestInfrastructure] =
    Containers.allContainers(Containers.openSearch(Containers.Images.openSearch1))
}
