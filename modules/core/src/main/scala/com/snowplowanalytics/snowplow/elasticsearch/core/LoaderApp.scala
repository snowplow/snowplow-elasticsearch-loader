...
abstract class LoaderApp[FactoryConfig: Decoder, SourceConfig: Decoder, BadSinkConfig: Decoder](info: AppInfo)
    extends CommandIOApp(
      name    = s"docker run ${info.dockerAlias}",
      header  = info.dockerAlias,
